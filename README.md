...
## معرفی <br>
Xcs یک وب اپلیکیشن جهت مدیریت چندگانه و مناسب  XPanel
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Alirezad07/Xcs-Multi-Management-XPanel/master/install.sh --ipv4)
```
<br>
<br>
